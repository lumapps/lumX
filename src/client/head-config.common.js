 ...
 * You can explicitly hint to prefix a publicPath by setting a boolean value to a key that has the same name as the
 * attribute you want to operate on, but prefix with '='.
 *
 * Example:
