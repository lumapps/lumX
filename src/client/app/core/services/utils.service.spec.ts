...
describe('Utils Service', () => {
    ...
    describe('`isDefined`', () => {
        ...
        it('should return true if value is a non-empty object-like', () => {
            ...
            const toDoItem: ToDoItem = new ToDoItem('Ned Stark');
            expect(UtilsService.isDefined(toDoItem)).to.be.true;
        });
    ...
    describe('`isDefinedAndFilled`', () => {
        ...
        it('should return true if value is a non-empty object-like', () => {
            ...
            const toDoItem: ToDoItem = new ToDoItem('Ned Stark');
            expect(UtilsService.isDefinedAndFilled(toDoItem)).to.be.true;
        });
    ...
    describe('`isUndefined`', () => {
        ...
        it('should return false if value is a non-empty object-like', () => {
            ...
            const toDoItem: ToDoItem = new ToDoItem('Ned Stark');
            expect(UtilsService.isUndefined(toDoItem)).to.be.false;
        });
    ...
    describe('`isUndefinedOrEmpty`', () => {
        ...
        it('should return false if value is a non-empty object-like', () => {
            ...
            const toDoItem: ToDoItem = new ToDoItem('Ned Stark');
            expect(UtilsService.isUndefinedOrEmpty(toDoItem)).to.be.false;
        });
