export const SELECTOR_PREFIX: string = 'lx';
export const SELECTOR_SEPARATOR: string = '-';

export const NOT_FOUND_SELECTOR: string = 'not-found';

// demo app selectors
export const DEMO_SELECTOR: string = 'demo';
export const HEADER_SELECTOR: string = 'header';
export const PRIMARY_NAV_SELECTOR: string = 'primary-nav';
export const PRIMARY_NAV_LINK_SELECTOR: string = 'primary-nav-link';
export const SECONDARY_NAV_SELECTOR: string = 'secondary-nav';
export const SECONDARY_NAV_LINK_SELECTOR: string = 'secondary-nav-link';
